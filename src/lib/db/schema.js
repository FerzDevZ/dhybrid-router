...
export const TABLES = {
  ...
  proxyPools: {
    ...
    indexes: [
      ...
      "CREATE INDEX IF NOT EXISTS idx_pp_auto_delete ON proxyPools(autoDelete)",
    ],
  },
  apiKeys: {
    columns: {
  ...
  usageHistory: {
    ...
    indexes: [
      ...
      "CREATE INDEX IF NOT EXISTS idx_uh_status_ts ON usageHistory(status, timestamp DESC)",
