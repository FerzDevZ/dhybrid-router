...
if (require.main === module) {
  // Repo layout: standalone server lives under .next/standalone/.
  // Docker/CLI layout: standalone content is copied to the app root.
  const standalone = path.join(__dirname, ".next", "standalone", "server.js");
  require(fs.existsSync(standalone) ? standalone : "./server.js");
}
